...
const NavItem = <>
    ...
    <NavLink to='/AllPlants' ><li className='px-2 py-1 rounded-sm'>All-Plants</li></NavLink>
                ...
                <div className='navbar py-5 max-w-11/12 mx-auto'>
                    ...
                    <div className="navbar-center  hidden lg:flex">
                        <ul className="menu menu-horizontal px-1 space-x-7  text-lg">
                            ...
                            {
                                user && (
                                    <NavLink to="/dashboard"><li className="px-2 py-1 rounded-sm">Dashboard</li></NavLink>
                                )
                            }
                        </ul>
                    </div>
